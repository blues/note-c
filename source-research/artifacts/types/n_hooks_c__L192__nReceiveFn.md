...
- Kind: typedef
- Definition: `n_hooks.c:192`
- Declaration/interface: source/header type declaration as noted.
- Public/exported names: `nReceiveFn` where named; generated placeholder names are internal extractor labels.
- Macro aliases/wrappers: not applicable.
- Signature/API shape: `const char *(*)(uint8_t *, uint32_t *, bool, uint32_t, uint32_t *)`
...
- Graph node id: `typedef:n_hooks.c:192:nReceiveFn`
