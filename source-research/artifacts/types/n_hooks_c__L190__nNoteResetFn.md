...
- Kind: typedef
- Definition: `n_hooks.c:190`
- Declaration/interface: source/header type declaration as noted.
- Public/exported names: `nNoteResetFn` where named; generated placeholder names are internal extractor labels.
...
- Graph node id: `typedef:n_hooks.c:190:nNoteResetFn`
