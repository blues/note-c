...
- Public/exported names: `txnStopFn` where named; generated placeholder names are internal extractor labels.
...
Defines the public platform hook callback type for the transaction stop hook. Hook setter/getter APIs store or return function pointers of this type; wrapper functions dispatch through the configured hook when set.
...
NoteSetFnTransaction/NoteGetFnTransaction and transaction stop dispatch
...
- Graph node id: `typedef:note.h:289:txnStopFn`
