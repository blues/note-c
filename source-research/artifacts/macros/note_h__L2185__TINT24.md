...
- Kind: macro
- Definition: `note.h:2185`
- Declaration/interface: public header macro in `note.h`.
- Public/exported names: `TINT24`
- Macro aliases/wrappers: literal `13`
...
3-byte signed integer template code; intended to be encoded as a JSON number in a template body. `NoteTemplate` attaches and sends the caller-owned body unchanged.
...
- Graph node id: `macro:note.h:2185:TINT24`
