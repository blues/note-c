...
- Kind: macro
- Definition: `note.h:2191`
- Declaration/interface: public header macro in `note.h`.
- Public/exported names: `TUINT32`
- Macro aliases/wrappers: literal `24`
...
4-byte unsigned integer template code; header notes firmware support requirement. `NoteTemplate` attaches and sends the caller-owned body unchanged.
...
- Graph node id: `macro:note.h:2191:TUINT32`
