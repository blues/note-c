...
- Kind: macro
- Definition: `note.h:2188`
- Declaration/interface: public header macro in `note.h`.
- Public/exported names: `TUINT8`
- Macro aliases/wrappers: literal `21`
...
1-byte unsigned integer template code; header notes firmware support requirement. `NoteTemplate` attaches and sends the caller-owned body unchanged.
...
- Graph node id: `macro:note.h:2188:TUINT8`
