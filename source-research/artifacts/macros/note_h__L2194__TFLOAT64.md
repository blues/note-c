...
- Kind: macro
- Definition: `note.h:2194`
- Declaration/interface: public header macro in `note.h`.
- Public/exported names: `TFLOAT64`
- Macro aliases/wrappers: literal `18.1`
...
8-byte IEEE-754 floating template code; intended to be encoded as JSON number. `NoteTemplate` attaches and sends the caller-owned body unchanged.
...
- Graph node id: `macro:note.h:2194:TFLOAT64`
