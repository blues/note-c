...
- Kind: macro
- Definition: `note.h:2184`
- Declaration/interface: public header macro in `note.h`.
- Public/exported names: `TINT16`
- Macro aliases/wrappers: literal `12`
...
2-byte signed integer template code; intended to be encoded as a JSON number in a template body. `NoteTemplate` attaches and sends the caller-owned body unchanged.
...
- Graph node id: `macro:note.h:2184:TINT16`
