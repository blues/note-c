...
- Kind: macro
- Definition: `note.h:2186`
- Declaration/interface: public header macro in `note.h`.
- Public/exported names: `TINT32`
- Macro aliases/wrappers: literal `14`
...
4-byte signed integer template code; intended to be encoded as a JSON number in a template body. `NoteTemplate` attaches and sends the caller-owned body unchanged.
...
- Graph node id: `macro:note.h:2186:TINT32`
