...
- Public/exported names: `NOTE_C_VERSION_MAJOR`
...
Defines the major component of the SDK version. `NOTE_C_VERSION` expands and stringizes this component into the public version string.
...
- Graph node id: `macro:note.h:42:NOTE_C_VERSION_MAJOR`
