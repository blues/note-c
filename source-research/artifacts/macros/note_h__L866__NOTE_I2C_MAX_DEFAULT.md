...
Mirrors a pre-defined `NOTE_I2C_MTU_DEFAULT` into `NOTE_I2C_MAX_DEFAULT` when the newer/default counterpart is supplied.
...
- Graph node id: `macro:note.h:866:NOTE_I2C_MAX_DEFAULT`
