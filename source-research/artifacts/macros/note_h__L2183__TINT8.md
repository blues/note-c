...
- Kind: macro
- Definition: `note.h:2183`
- Declaration/interface: public header macro in `note.h`.
- Public/exported names: `TINT8`
- Macro aliases/wrappers: literal `11`
...
1-byte signed integer template code; intended to be encoded as a JSON number in a template body. `NoteTemplate` attaches and sends the caller-owned body unchanged.
...
- Graph node id: `macro:note.h:2183:TINT8`
