...
- Kind: macro
- Definition: `note.h:2192`
- Declaration/interface: public header macro in `note.h`.
- Public/exported names: `TFLOAT16`
- Macro aliases/wrappers: literal `12.1`
...
2-byte IEEE-754 floating template code; intended to be encoded as JSON number. `NoteTemplate` attaches and sends the caller-owned body unchanged.
...
- Graph node id: `macro:note.h:2192:TFLOAT16`
